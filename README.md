...
Required If Validator (Conditional)

Checkbox Required Validator

Dropdown Required Validator

Unique Value Validator

Username Exists Validator (Async)
...
Range Validator (Min-Max Value)# basic_custom_validation_Form_Angular_21
